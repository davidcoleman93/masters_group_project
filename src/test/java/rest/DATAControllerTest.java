...
public class DATAControllerTest extends DATAControllerSetUp {
    ...
    public void exactEventCausePerIMSI(){
        ...
        given()
                .when()
                .get("event_cause_per_imsi/" + testIMSI)
                .then()
                .statusCode(200)
                .assertThat()
    ...
    public void validSpecificFailurePerPeriod() {
        ...
        given().when().get("specific_failure_per_period/"+ startDate + "/" + endDate + "/" + testIMSI).then().statusCode(200);
    }
    ...
    public void validFailureCountPerModel() {
        ...
        given().when().get("count_per_phone_model/" + startDate + "/" + endDate + "/" + phoneModel).then().statusCode(200);
    }
