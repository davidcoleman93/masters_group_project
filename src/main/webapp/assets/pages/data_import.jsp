...
************************************************************************************************************************************************* -->
                            ...
                            <header class="header black-bg">
                                ...
                                <!--logo start--><a href="../../home.html" class="logo"><b>LTE Failure System</b></a>
                                <!--logo end-->
...
<li><a  href="assets/pages/chartjs.html">Chartjs</a></li>
                                        ...
                                        <li class="sub-menu">
                                            <a class="active" href="data_import.jsp"> <i class="fa fa-cogs"></i> <span>Data Import</span> </a>
                                            <!--<ul class="sub">
                                ...
                                <section class="wrapper">
                                    <div class="row">
                                        <div class="row mtbox">
                                            <div class="col-lg-12">
                                                <p>
                                                    <input type="file" accept=".xls,.xlsx,.xlsm,.xlsb" id="excel" value="csv">
                                                    <p id="uploadMsg">Select XlS File</p>
                                                    <button id="isubmit">Submit</button>
                                                </p> <pre id="display"></pre>
                                                <br />
                            ...
                            <footer class="site-footer">
                                <footer class="site-footer">
                                    <div class="text-center"> LTE Failure System
                                        <a href="data_import.jsp#" class="go-top"> <i class="fa fa-angle-up"></i> </a>
                                    </div>
                                </footer>
                            </footer>
                            <!--footer end-->
