...
{
    $("#query_input").append(' <tbody> <tr> <td class="name"> <form class="form-inline"> <div class="form-group"> <label id = "query_label" for="query_dropdown"></label> <select id="query_dropdown"></select> </div> </form> </td> <td class="name"> <input type="button" id="queryBtn" class="btn btn-primary" value="Submit"> </td> </tr> </tbody>');
}

function queryOutputStructure()
{
    $("#query_output").append('<div class="col-md-12 mt"> <div class="content-panel"> <p id = "searched" class="bg-info"></p> <table id="results" class="table table-hover"><!-- table-bordered --> </table> </div><! --/content-panel --> </div><!-- /col-md-12 -->');
