    ...
    $("#checkbox1").change(function () {
        ...
        if (0 == w) d.html("Sorry <i>username</i> is invalid");
            ...
            e = e.concat($("#user-login").val() + "/"), $.ajax({
                ...
                success: function (e) {
                    0 == e ? window.location.replace("http://localhost:8080/LteFailureSystem-0.0.1-SNAPSHOT/home.html") : (d.removeClass("m-progress"), $("#pwlsign").addClass("danger"), $("#pwlsign").removeClass("success"), $("#pwlsign").removeClass("warning"), $("#pwlsign").html("&#10005;"), d.html("Sorry  <i> password </i> is incorrect. "))
                },
                error: function () {
