...
public class UserEventType implements Serializable {
	...
	public UserEventType(Integer tac, String marketingName, String manufacturer, String accessCapability, String model,
			String vendorName, String ueDevice, String operatingSystem, String inputMode) {
		this.tac = tac;
