...
public class FailureEvent implements Serializable {
	...
	@JoinColumns({ @JoinColumn(name = "market", referencedColumnName = "mcc"),
	...
	public FailureEvent(Date dateTime, EventCause eventCause, FailureClass failureClass, UserEventType userEventType,
			MarketOperator marketOperator, Integer cellID, Integer duration, String neVersion, Long imsi) {
